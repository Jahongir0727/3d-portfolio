...
//
//
    emailjs.send('service_kxo7vqj', 'template_37pzyxe', {from_name: form.name, to_name: 'Jay', from_email: form.email, to_email: 'urakovdzhakhongir27@gmail.com', messagae: form.message,},'dC19Ha5EL_-A0zZN7')
    .then(() => {
      setLoading(false);
  ...
  return (
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      ...
      <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
        ...
        <button type="submit" className="bg-tertiary py-3 px-8 outline-none text-white font-bold shadow-md shadow-primary w-fit rounded-xl">
